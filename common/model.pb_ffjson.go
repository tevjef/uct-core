...
handle_Synopsis:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			uj.Synopsis = string(string(outBuf))
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Sections type=*common.Section kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Metadata type=*common.Metadata kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Meetings type=*common.Meeting kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Instructors type=*common.Instructor kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Books type=*common.Book kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Courses type=*common.Course kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Subjects type=*common.Subject kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__AvailableSemesters type=*common.Semester kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Registrations type=*common.Registration kind=ptr quoted=false*/
