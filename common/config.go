...
const (
	UCT_POSTGRES_HOST = "POSTGRES_PORT_5432_TCP_ADDR"
	UCT_POSTGRES_NAME = "POSTGRES_DB"
	UCT_POSTGRES_PASSWORD = "POSTGRES_PASSWORD"
	UCT_POSTGRES_USER = "POSTGRES_USER"
	UCT_POSTGRES_PORT = "POSTGRES_PORT_5432_TCP_PORT"

	UCT_INFLUXDB_HOST = "INFLUXDB_PORT_8086_TCP_ADDR"
	UCT_INFLUXDB_PORT = "INFLUXDB_PORT_8086_TCP_PORT"
	UCT_INFLUXDB_USER = "INFLUXDB_ADMIN_USER"
	UCT_INFLUXDB_PASSWORD = "INFLUXDB_ADMIN_PASSWORD"
...
func (c *Config) fromEnvironment() {
	// Database
	c.Db.User = bindEnv(c.Db.User, UCT_POSTGRES_USER)
	c.Db.Host = bindEnv(c.Db.Host, UCT_POSTGRES_HOST)
	c.Db.Port = bindEnv(c.Db.Port, UCT_POSTGRES_PASSWORD)
	c.Db.Name = bindEnv(c.Db.Name, UCT_POSTGRES_NAME)
	c.Db.Port = bindEnv(c.Db.Port, UCT_POSTGRES_PORT)
