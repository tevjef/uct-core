...
func NewPopulatedData(r randyModel, easy bool) *Data {
	...
	if r.Intn(10) != 0 {
		v27 := r.Intn(5)
		this.Universities = make([]*University, v27)
		for i := 0; i < v27; i++ {
	...
	if r.Intn(10) != 0 {
		v28 := r.Intn(5)
		this.Subjects = make([]*Subject, v28)
		for i := 0; i < v28; i++ {
			this.Subjects[i] = NewPopulatedSubject(r, easy)
		}
	}
	...
	if r.Intn(10) != 0 {
		v30 := r.Intn(5)
		this.Sections = make([]*Section, v30)
		for i := 0; i < v30; i++ {
			this.Sections[i] = NewPopulatedSection(r, easy)
		}
	}
...
func randFieldModel(data []byte, r randyModel, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		data = encodeVarintPopulateModel(data, uint64(v32))
	case 1:
		data = encodeVarintPopulateModel(data, uint64(key))
...
var fileDescriptorModel = []byte{
	...
	,
}
