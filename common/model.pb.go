...
type Universities struct {
	Universities     []University `protobuf:"bytes,1,rep,name=universities" json:"universities"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func NewPopulatedUniversities(r randyModel, easy bool) *Universities {
	...
	if r.Intn(10) != 0 {
		v9 := r.Intn(5)
		this.Universities = make([]University, v9)
		for i := 0; i < v9; i++ {
			v10 := NewPopulatedUniversity(r, easy)
			this.Universities[i] = *v10
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedSubject(r randyModel, easy bool) *Subject {
	...
	if r.Intn(10) != 0 {
		v13 := r.Intn(5)
		this.Courses = make([]Course, v13)
		for i := 0; i < v13; i++ {
			v14 := NewPopulatedCourse(r, easy)
			this.Courses[i] = *v14
		}
	}
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v15; i++ {
			v16 := NewPopulatedMetadata(r, easy)
			this.Metadata[i] = *v16
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedCourse(r randyModel, easy bool) *Course {
	...
	if r.Intn(10) != 0 {
		v18 := r.Intn(5)
		this.Sections = make([]Section, v18)
		for i := 0; i < v18; i++ {
			v19 := NewPopulatedSection(r, easy)
			this.Sections[i] = *v19
		}
	}
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v20; i++ {
			v21 := NewPopulatedMetadata(r, easy)
			this.Metadata[i] = *v21
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedSection(r randyModel, easy bool) *Section {
	...
	if r.Intn(10) != 0 {
		v22 := r.Intn(5)
		this.Meetings = make([]Meeting, v22)
		for i := 0; i < v22; i++ {
			v23 := NewPopulatedMeeting(r, easy)
			this.Meetings[i] = *v23
		}
	}
	if r.Intn(10) != 0 {
		v24 := r.Intn(5)
		this.Instructors = make([]Instructor, v24)
		for i := 0; i < v24; i++ {
			v25 := NewPopulatedInstructor(r, easy)
			this.Instructors[i] = *v25
		}
	}
	if r.Intn(10) != 0 {
		v26 := r.Intn(5)
		this.Books = make([]Book, v26)
		for i := 0; i < v26; i++ {
			v27 := NewPopulatedBook(r, easy)
			this.Books[i] = *v27
		}
	}
	if r.Intn(10) != 0 {
...
func NewPopulatedMeeting(r randyModel, easy bool) *Meeting {
	...
	if r.Intn(10) != 0 {
		v30 := randStringModel(r)
		this.Room = &v30
	}
	if r.Intn(10) != 0 {
		v31 := randStringModel(r)
		this.Day = &v31
	}
	...
	if r.Intn(10) != 0 {
		v32 := r.Intn(5)
		this.Metadata = make([]Metadata, v32)
		for i := 0; i < v32; i++ {
			v33 := NewPopulatedMetadata(r, easy)
			this.Metadata[i] = *v33
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func randFieldModel(data []byte, r randyModel, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		data = encodeVarintPopulateModel(data, uint64(v40))
	case 1:
		data = encodeVarintPopulateModel(data, uint64(key))
...
func (this *Universities) String() string {
	...
	s := strings.Join([]string{`&Universities{`,
		`Universities:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Universities), "University", "University", 1), `&`, ``, 1) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
...
var fileDescriptorModel = []byte{
	...
	,
}
