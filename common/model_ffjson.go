...
handle_UctSemester:
	...
	/* handler: uj.UctSemester type=[]common.Semester kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			uj.UctSemester = make([]Semester, 0)

			wantVal := true

			for {

				var tmp_uj__UctSemester Semester
				...
				/* handler: tmp_uj__UctSemester type=common.Semester kind=struct quoted=false*/
