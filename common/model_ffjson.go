...
func (mj *UctSemester) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if mj == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
func (mj *UctSemester) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if mj == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffj_t_UctSemesterbase = iota
	ffj_t_UctSemesterno_such_key

	ffj_t_UctSemester_Year

	ffj_t_UctSemester_Season
)

var ffj_key_UctSemester_Year = []byte("year")

var ffj_key_UctSemester_Season = []byte("season")

func (uj *UctSemester) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return uj.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

func (uj *UctSemester) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error = nil
	currentKey := ffj_t_UctSemesterbase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffj_t_UctSemesterno_such_key
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 's':
					...
					if bytes.Equal(ffj_key_UctSemester_Season, kn) {
						currentKey = ffj_t_UctSemester_Season
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'y':
					...
					if bytes.Equal(ffj_key_UctSemester_Year, kn) {
						currentKey = ffj_t_UctSemester_Year
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_UctSemester_Season, kn) {
					currentKey = ffj_t_UctSemester_Season
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_UctSemester_Year, kn) {
					currentKey = ffj_t_UctSemester_Year
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_UctSemester_Year:
					goto handle_Year

				case ffj_t_UctSemester_Season:
					goto handle_Season

				case ffj_t_UctSemesterno_such_key:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
func (mj *University) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if len(mj.UctSemester) != 0 {
		buf.WriteString(`"semesters":`)
		if mj.UctSemester != nil {
			buf.WriteString(`[`)
			for i, v := range mj.UctSemester {
				if i != 0 {
					buf.WriteString(`,`)
				}
...
var ffj_key_University_UctSemester = []byte("semesters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 's':
					...
					} else if bytes.Equal(ffj_key_University_UctSemester, kn) {
						currentKey = ffj_t_University_UctSemester
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_University_UctSemester, kn) {
					currentKey = ffj_t_University_UctSemester
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_University_UctSemester:
					goto handle_UctSemester
...
handle_UctSemester:
	...
	/* handler: uj.UctSemester type=[]common.UctSemester kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			uj.UctSemester = make([]UctSemester, 0)

			wantVal := true

			for {

				var tmp_uj__UctSemester UctSemester
				...
				/* handler: tmp_uj__UctSemester type=common.UctSemester kind=struct quoted=false*/

				{
					...
					err = tmp_uj__UctSemester.UnmarshalJSONFFLexer(fs, fflib.FFParse_want_key)
					if err != nil {
						return err
					}
					state = fflib.FFParse_after_value
				...
				uj.UctSemester = append(uj.UctSemester, tmp_uj__UctSemester)
				wantVal = false
			}
		}
	}
