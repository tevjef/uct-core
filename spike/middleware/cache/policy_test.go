...
func TestPolicy_CacheControl(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "time.Second, time.Second, NoStore", fields: fields{time.Second, time.Second, NoStore}, want: "public, max-age=1"},
		{name: "time.Second, time.Second, NoCache", fields: fields{time.Second, time.Second, NoCache}, want: "public, max-age=1"},
		...
		{name: "time.Second, 0, NoStore", fields: fields{time.Second, 0, NoStore}, want: "public, max-age=1"},
		{name: "time.Second, 0, NoCache", fields: fields{time.Second, 0, NoCache}, want: "public, max-age=1"},
		{name: "time.Second, 0, 0", fields: fields{time.Second, 0, 0}, want: "public, max-age=1"},
		...
		{name: "0, time.Second, NoStore", fields: fields{0, time.Second, NoStore}, want: "public, max-age=1"},
		{name: "0, time.Second, NoCache", fields: fields{0, time.Second, NoCache}, want: "public, max-age=1"},
