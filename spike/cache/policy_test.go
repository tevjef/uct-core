...
func TestPolicy_CacheControl(t *testing.T) {
	...
	tests := []struct {
		...
		{name:"time.Second, time.Second, Public", fields:fields{time.Second, time.Second, Public}, want:"max-age=1"},
		{name:"time.Second, time.Second, Private", fields:fields{time.Second, time.Second, Private}, want:"private, max-age=1"},
		{name:"time.Second, time.Second, NoStore", fields:fields{time.Second, time.Second, NoStore}, want:"max-age=1"},
		{name:"time.Second, time.Second, NoCache", fields:fields{time.Second, time.Second, NoCache}, want:"max-age=1"},
		{name:"time.Second, 0, Public", fields:fields{time.Second, 0, Public}, want:"max-age=1"},
		{name:"time.Second, 0, Private", fields:fields{time.Second, 0, Private}, want:"private, max-age=1"},
		{name:"time.Second, 0, NoStore", fields:fields{time.Second, 0, NoStore}, want:"max-age=1"},
		{name:"time.Second, 0, NoCache", fields:fields{time.Second, 0, NoCache}, want:"max-age=1"},
		{name:"time.Second, 0, 0", fields:fields{time.Second, 0, 0}, want:"max-age=1"},
		{name:"time.Second, 0, 0", fields:fields{time.Second, 0, Private}, want:"private, max-age=1"},
		{name:"time.Second, 0, NoStore", fields:fields{time.Second, 0, NoStore}, want:"max-age=1"},
		{name:"time.Second, 0, NoCache", fields:fields{time.Second, 0, NoCache}, want:"max-age=1"},
		{name:"0, time.Second, Public", fields:fields{0, time.Second, Public}, want:"max-age=1"},
		{name:"0, time.Second, Private", fields:fields{0, time.Second, Private}, want:"private, max-age=1"},
		{name:"0, time.Second, NoStore", fields:fields{0, time.Second, NoStore}, want:"max-age=1"},
		{name:"0, time.Second, NoCache", fields:fields{0, time.Second, NoCache}, want:"max-age=1"},
